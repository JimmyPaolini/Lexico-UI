...
export default function AdjectiveCard({forms}) {
...
const adjectiveFormsRestructure = forms => {
    ...
    function structureGender(struc, GEN, gender) {
        ...
        if (forms.vocative) {
            struc[GEN].splice(struc[GEN].length, 0,
                {
                    topLeft: "VOC",
